                   ...
                   <div class="col-sm-6"><!-- col-sm-6 Begin -->
                       <div class="box"><!-- box Begin -->
                           ...
                           if(!isset($_SESSION['customer_email'])){
                            die("You should be logged in to Add items to order cart");
                        }
                        $total = total_price2();
                        add_cart($total); 
                           ...
                           <form action="details.php?add_cart=<?php echo $product_id; ?>" class="form-horizontal" method="post"><!-- form-horizontal Begin -->
                               <div class="form-group"><!-- form-group Begin -->
                                   <label for="" class="col-md-5 control-label">Product(s) Quantity (Per Products)</label>
                               ...
                               <div class="form-group"><!-- form-group Begin -->
                                   ...
                                   <div class="col-md-7"><!-- col-md-7 Begin -->
                                       ...
                                       <select name="product_size" class="form-control" required oninput="setCustomValidity('')" oninvalid="setCustomValidity('Must pick 1 size for the product')"><!-- form-control Begin -->
                                           ...
                                           <option>Sugary</option>
                                           <option>Sugarless</option>
                                           <option>Other</option>
                               ...
                               <p class="text-center buttons"><button class="btn btn-primary i fa fa-fw fa-shopping-cart" name="addToCart"><i class="fa fa-fw fa-shopping-cart"></i> Add to cart</button></p>
